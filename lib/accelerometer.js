  ...
  LSM303C: {
    ...
    initialize: {
      value: function(opts, dataHandler) {
        ...
        // this.io.i2cWrite(address, this.REGISTER.SETUP_REG4, this.REGISTER.ACC_FULLSCALE_2G);

        // // Block Data Update
        // this.io.i2cWrite(address, this.REGISTER.SETUP_REG1, this.REGISTER.ACC_BDU_ENABLE);

        // // Read values
        // this.io.i2cRead(address, this.REGISTER.OUTX_L, READLENGTH, function(data) {
